...
public class BLevel3L2 {
	...
	/* Filler, 66-94, AN 29, Space Filled. */
	...
	public static BLevel3L2 fromString(String s) {
		if (StringUtils.isEmpty(s) || s.length() != 100 || !s.startsWith("L2")) {
			return null;
		}
		BLevel3L2 l2 = new BLevel3L2();
