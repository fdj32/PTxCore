...
public class BLevel3P1 {
	...
	public static BLevel3P1 fromString(String s) {
		if (StringUtils.isEmpty(s) || s.length() != 100 || !s.startsWith("P1")) {
			return null;
		}
		BLevel3P1 p1 = new BLevel3P1();
		...
		p1.setRecordSequenceNumber(s.substring(94, 100));
		return p1;
	}
